...
import { createModelAliasTransform } from "../../services/modelAliasTransform.ts";
import {
...
export function assembleStreamingPipeline(
  ...
  // Spoof: Transform model aliases in streaming response (shows alias instead of original)
  finalStream = finalStream.pipeThrough(createModelAliasTransform());
